    ...
    spotlights: [
      {
        ...
        image: { src: "/vscode-extension.png", alt: "RyunixJS VS Code extension editing a .ryx file" },
    ...
    buildSpotlights: [
      {
        ...
        image: {
          src: "/ssg-output.png",
          alt: "Static HTML output from ryunix build",
          fit: "contain",
        },
      ...
      },
      {
        ...
        image: { src: "/cli-terminal.png", alt: "ryunix CLI commands in a terminal" },
    ...
    spotlights: [
      {
        ...
        linkPath: "guides/vscode",
        image: { src: "/vscode-extension.png", alt: "Extensión RyunixJS en VS Code editando un archivo .ryx" },
    ...
    buildSpotlights: [
      {
        ...
        image: {
          src: "/ssg-output.png",
          alt: "Salida HTML estática de ryunix build",
          fit: "contain",
        },
      ...
      },
      {
        ...
        linkPath: "guides/create-app",
        image: { src: "/cli-terminal.png", alt: "Comandos ryunix CLI en terminal" },
