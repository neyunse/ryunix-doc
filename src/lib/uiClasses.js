...
export const siteHeaderShellClass = cn(
  "site-header sticky top-0 z-[100] backdrop-blur-md bg-header",
  "border-b border-theme text-theme",
  "min-h-[var(--ui-header-height)] sm:h-[var(--ui-header-height)]",
);

export const siteHeaderInnerClass = cn(
  "w-full max-w-[var(--ui-container)] mx-auto px-4 sm:px-6 lg:px-8",
  "flex flex-col gap-3 py-3 sm:flex-row sm:items-center sm:justify-between sm:gap-4 sm:py-0 sm:h-full",
);
...
export const copyButtonClass = (copied, extra = "") =>
  cn(
...
export const docSidebarLinkClass = (isActive) =>
  cn(
